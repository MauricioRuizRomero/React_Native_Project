                ...
                <View style= {styles.badge}>
                    ...
                    <View style={styles.data}>
                        ...
                        <View style={styles.dataColumns}>
                            <Text style={styles.dataInfo}>{badge.life || "?"}  </Text>
                            <Text style={styles.smallText}>HP</Text>
                        </View>
                        <View style={styles.dataColumns}>
                            <Text style={styles.dataInfo}>{badge.magic || "?"} </Text>
                            <Text style={styles.smallText}>MP</Text>
                        </View>
                        <View style={styles.dataColumns}>
                            <Text style={styles.dataInfo}>{badge.strenght || "?"} </Text>
                            <Text style={styles.smallText}>STG</Text>
                        </View>
